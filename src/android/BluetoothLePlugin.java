// Credits:
// If I can get this to work at all, I owed a debt of gratitude to Rand Dusing and his GitHub repo for BLE on android
// For my purposes, non-commercial (at least I am not getting paid a dime) self-teaching of BLE on Android,
// I would rather capture his stuff, bugs and all (there are still GitHub "issues" pending - he admits his Write stuff
// hasn't been tested) and freeze it at today's level. That way any fixes or hacks will teach me, rather than depend
// on someone else's priorities.

package com.frankrnichols.bluetoothle;
